			...
			<div class="header">
			 ...
			 <div class="my-5" style="background-color:#EAEAEA; width:100%;">
				<div class="inner">
					    ...
					    <div class="col-sm-7">
					    		...
					    		<ul>
					    			<li>
					    				...
					    				<div style="padding:8px 0;">네이밍/아이디어 | 프리미엄 패키지 <span style="color:red;">(환불불가)</span></div>
					    			</li>
					    			<li>
					    				<div style="padding:8px 0;">
					    					<span>상금 1등</span>
					    					<span class="pp">1,200,000원</span>
					    				</div>
					    				<div style="padding:8px 0;">
					    					<span>공모전 등록비</span>
					    					<span class="pp">100,000원</span>
					    				</div>
					    			</li>
					    			<li>
					    				<div style="padding:8px 0;">
					    					<span>페이스북/디자인 커뮤니티 홍보</span>
					    					<span class="pp">0원</span>
					    				</div>
					    				<div style="padding:8px 0;">
					    					<span>상단 노출 옵션</span>
					    					<span class="pp">0원</span>
					    			...
					    			<li>
					    				<div style="padding:8px 0;">
					    					<span>부가세(10%)</span>
					    					<span class="pp">130,000원</span>
					    				</div>
					    			</li>
					    			<li style="border-bottom:0;">
					    				<div style="padding:8px 0;">
					    					<span>합계</span>
					    					<span class="pp" style="color:red;">1,430,000원</span>
					    				</div>
					    			</li>
					    		</ul>
					    	</div>
					...
					<button type="button" onclick="location.href='#'" class="subtype1">결제하기</button>
				</div>
			</div>
