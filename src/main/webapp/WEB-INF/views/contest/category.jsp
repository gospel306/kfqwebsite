					    ...
					    <div class="col-sm-7">
					    	...
					    	<button type="button" onclick="location.href='launch/logo&bizcard'" class="subtype rounded w-100">
					    		...
					    		<div class="detail">
						    		...
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 로고 디자인</p>
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 명함 디자인</p>
					    		</div>
					    	</button>
					    	<button type="button" onclick="location.href=#" class="subtype rounded w-100">
					    		...
					    		<div class="detail">
						    		...
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 로고 디자인</p>
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 간판 디자인</p>
					    		</div>
					    	</button>
					    	<button type="button" onclick="location.href=#" class="subtype rounded w-100">
					    		...
					    		<div class="detail">
						    		...
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 명함 디자인</p>
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 간판 디자인</p>
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 서식류 디자인</p>
					    		</div>
					    	</button>
					    </div>
					</div>
					    ...
					    <div class="col-sm-7">
					    	<button type="button" onclick="location.href=#" class="subtype rounded w-100">
					    		...
					    		<div class="detail">
						    		...
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 추후 디자인 콘테스트 개최시 <span style="color:red;">10만원 할인</span></p>
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 브랜드, 제품 네이밍 아이디어</p>
						    		<p class="sub4"><img src="imag\check.png" alt="..." class="check"> 회사 슬로건 / 광고카피 아이디어</p>
					    		</div>
					    	</button>
					    </div>
					</div>
